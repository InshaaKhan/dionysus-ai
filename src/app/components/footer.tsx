    ...
    <footer className="w-full border-t bg-background px-20">
      <div className="container flex flex-col items-center justify-between gap-4 py-10 md:h-24 md:flex-row md:py-0">
        ...
        <div className="flex items-center gap-4">
          <Link href="https://github.com/InshaaKhan" target="_blank" className="hover:text-primary">
          ...
          <Link href="www.linkedin.com/in/insha-khan-30b549308/" target="_blank" className="hover:text-primary">
